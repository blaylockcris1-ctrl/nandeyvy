    ...
    <section class="hero"><div class="wrap">
      ...
      <form class="searchbox" onsubmit="event.preventDefault(); goSearch();">
        ...
        <select id="q-city"><option value="">Todo el país</option>
          <option>Asunción</option><option>Luque</option><option>San Lorenzo</option><option>Lambaré</option>
          <option>Ciudad del Este</option><option>Encarnación</option><option>Altos</option><option>Caaguazú</option>
        </select>
    ...
    <form class="wizard" onsubmit="event.preventDefault(); saveListing();">
      ...
      <div class="row2">
        <div class="field"><label>Ciudad</label>
          <select id="p-city"><option>Asunción</option><option>Luque</option><option>Lambaré</option><option>San Lorenzo</option><option>Ciudad del Este</option><option>Encarnación</option><option>Caaguazú</option></select></div>
        <div class="field"><label>Barrio</label><input id="p-barrio" placeholder="Villa Morra" required></div>
      </div>
      <div class="row2">
        <div class="field"><label>Precio</label><input id="p-price" type="number" min="1" required placeholder="185000"></div>
        <div class="field"><label>Moneda</label><select id="p-cur"><option value="USD">USD</option><option value="PYG">PYG</option></select></div>
      </div>
      <div class="row2">
      ...
      <button class="btn btn-dark" type="submit">Continuar (pago simulado)</button>
    </form>`;
}
